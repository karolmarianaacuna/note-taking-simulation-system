 ...
 * @author USUARIO
 */
public class FrmSincronizarFinanzas extends javax.swing.JFrame {

    
    private String titulos[] = {"id_NotasFinanzas", "Titulo1_Nota", "fecha_Creacion", "descripcion", "metodoPago"};
    private DefaultTableModel modeloTabla = new DefaultTableModel(titulos, 0);

    public FrmSincronizarFinanzas() {
        initComponents();
    ...
    private void cargarDatos(String string) {
          ...
          List<NotaFinanza> arrProd;
         DAOSNotaFinanza miDao = new DAOSNotaFinanza();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOTAS FINANZAS");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSincronizarFinanzas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSincronizarFinanzas().setVisible(true);
            }
        });
    }
