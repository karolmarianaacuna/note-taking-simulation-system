 ...
 * @author USUARIO
 */
public class FrmSincronizarPersonal extends javax.swing.JFrame {
    
     private String titulos[] = {"id_NotasPersonal", "Titulo1_Nota", "fecha_Creacion", "descripcion", "signosVitales"};
    private DefaultTableModel modeloTabla = new DefaultTableModel(titulos, 0);

    /**
     * Creates new form FrmSincronizarPersonal
     */
    public FrmSincronizarPersonal() {
        initComponents();
     ...
     private void cargarDatos(String string) {
              ...
              List<NotaPersonal> arrProd;
         DAOSNotaPersonal miDao = new DAOSNotaPersonal();
        ...
        arrProd.forEach((elLugar) -> {
            ...
            filita[4] = elLugar.getEstadoAnimo();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("NOTAS Personal");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSincronizarPersonal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSincronizarPersonal().setVisible(true);
            }
        });
    }
