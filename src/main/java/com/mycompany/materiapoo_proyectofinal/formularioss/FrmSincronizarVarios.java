 ...
 * @author USUARIO
 */
public class FrmSincronizarVarios extends javax.swing.JFrame {
    
      private String titulos[] = {"id_NotasVarios", "Titulo1_Nota", "fecha_Creacion", "descripcion", "recordatorios"};
    private DefaultTableModel modeloTabla = new DefaultTableModel(titulos, 0);

    /**
     * Creates new form FrmSincronizarVarios
     */
    public FrmSincronizarVarios() {
        initComponents();
    ...
    private void cargarDatos(String string) {
          ...
          List<NotaVarios> arrProd;
         DAOSNotaVarios miDao = new DAOSNotaVarios();
        ...
        arrProd.forEach((elLugar) -> {
            ...
            filita[4] = elLugar.getRecordatorios();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSincronizarVarios.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSincronizarVarios().setVisible(true);
            }
        });
    }
