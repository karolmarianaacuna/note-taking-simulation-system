 ...
 * @author USUARIO
 */
public class FrmSincronizarTrabajo extends javax.swing.JFrame {
    
    private String titulos[] = {"id_NotasTrabajo", "Titulo1_Nota", "fecha_Creacion", "descripcion", "Prioridad", "Recordatorios"};
    private DefaultTableModel modeloTabla = new DefaultTableModel(titulos, 0);

    public FrmSincronizarTrabajo() {
        initComponents();
    ...
    private void cargarDatos(String notaString) {
        
        List<NotaTrabajo> arrProd;
        DAOSNotaTrabajo miDao = new DAOSNotaTrabajo();

        modeloTabla.setNumRows(0);

        arrProd = miDao.listar(notaString);
        arrProd.forEach((elLugar) -> {
            ...
            filita[4] = elLugar.getPrioridad();
            filita[5] = elLugar.getRecordatorios();
    ...
    private void initComponents() {
        ...
        if (TablaDatos.getColumnModel().getColumnCount() > 0) {
            ...
            TablaDatos.getColumnModel().getColumn(1).setHeaderValue("Titulo");
            TablaDatos.getColumnModel().getColumn(2).setHeaderValue("Fecha Creacion");
            TablaDatos.getColumnModel().getColumn(3).setHeaderValue("Descripcion ");
            TablaDatos.getColumnModel().getColumn(4).setHeaderValue("Tipo Emocion");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSincronizarTrabajo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSincronizarTrabajo().setVisible(true);
            }
        });
    }
