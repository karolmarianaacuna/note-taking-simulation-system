 ...
 * @author USUARIO
 */
public class FrmSincronizarSalud extends javax.swing.JFrame {
    
     private String titulos[] = {"id_NotasSalud", "Titulo1_Nota", "fecha_Creacion", "descripcion", "signosVitales"};
    private DefaultTableModel modeloTabla = new DefaultTableModel(titulos, 0);

    /**
     * Creates new form FrmSincronizarSalud
     */
    public FrmSincronizarSalud() {
        initComponents();
    ...
    private void cargarDatos(String string) {
            ...
            List<NotaSalud> arrProd;
         DAOSNotaSalud miDao = new DAOSNotaSalud();
        ...
        arrProd.forEach((elLugar) -> {
            ...
            filita[4] = elLugar.getSignosVitales();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmSincronizarSalud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmSincronizarSalud().setVisible(true);
            }
        });
    }
